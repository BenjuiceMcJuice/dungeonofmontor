...
var ITEMS = {
  ...
  regen_charm: {
    id: 'regen_charm', name: 'Trickle Charm', type: 'relic', slot: 'relic',
    rarity: 'uncommon', passiveEffect: 'regen_per_chamber', passiveValue: 2,
    buyPrice: 30, sellPrice: 12,
    description: 'Heal 2 HP every time you enter a new chamber.',
  },
  greater_regen_charm: {
    id: 'greater_regen_charm', name: 'Surge Charm', type: 'relic', slot: 'relic',
    rarity: 'rare', passiveEffect: 'regen_per_chamber', passiveValue: 4,
    buyPrice: 55, sellPrice: 22,
    description: 'Heal 4 HP every time you enter a new chamber.',
  },
  lucky_coin: {
...
var LOOT_TABLES = {
  ...
  garden_standard: {
    ...
    itemDropChance: 0.4,
    entries: [
      { itemId: 'health_potion',    weight: 45, minRarity: 'common' },
      { itemId: 'dagger_common',    weight: 10, minRarity: 'common' },
      { itemId: 'smoke_bomb',       weight: 10, minRarity: 'common' },
      { itemId: 'antidote',         weight: 8,  minRarity: 'common' },
      { itemId: 'leather_common',   weight: 8,  minRarity: 'uncommon' },
      { itemId: 'venomfang_dagger', weight: 5,  minRarity: 'uncommon' },
      { itemId: 'thorn_blade',      weight: 5,  minRarity: 'uncommon' },
      { itemId: 'regen_charm',      weight: 4,  minRarity: 'uncommon' },
  ...
  garden_elite: {
    ...
    entries: [
      ...
      { itemId: 'regen_charm',        weight: 5,  minRarity: 'uncommon' },
  ...
  garden_chest: {
    ...
    entries: [
      ...
      { itemId: 'regen_charm',           weight: 5,  minRarity: 'uncommon' },
      { itemId: 'greater_regen_charm',   weight: 3,  minRarity: 'rare' },
    ],
  },
